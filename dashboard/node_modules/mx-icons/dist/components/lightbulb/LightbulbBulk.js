  ...
  return /* @__PURE__ */ jsxs(
    Icon,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("path", { d: "M10.2978 13.6246C10.0904 13.266 9.63156 13.1435 9.27302 13.3509C8.91447 13.5583 8.79195 14.0171 8.99936 14.3757C9.35263 14.9864 9.93556 15.4498 10.631 15.6465V17.0001C10.631 17.4143 10.9668 17.7501 11.381 17.7501C11.7952 17.7501 12.131 17.4143 12.131 17.0001V15.6466C12.8264 15.4498 13.4094 14.9864 13.7626 14.3757C13.97 14.0171 13.8475 13.5583 13.489 13.3509C13.1304 13.1435 12.6716 13.266 12.4642 13.6246C12.247 14.0002 11.8427 14.2501 11.381 14.2501C10.9193 14.2501 10.515 14.0002 10.2978 13.6246Z", fill: "currentColor" }),
        /* @__PURE__ */ jsx("path", { d: "M9.91421 19.6745H13.0843C13.0814 19.7715 13.0769 19.8562 13.0701 19.9325C13.0516 20.1419 13.0203 20.2179 12.9988 20.2559C12.939 20.362 12.8529 20.4501 12.7493 20.5113C12.7121 20.5333 12.6378 20.5653 12.4331 20.5843C12.2191 20.6041 11.9366 20.6048 11.4993 20.6048C11.0619 20.6048 10.7795 20.6041 10.5654 20.5843C10.3607 20.5653 10.2864 20.5333 10.2493 20.5113C10.1456 20.4501 10.0595 20.362 9.99971 20.2559C9.97826 20.2179 9.94697 20.1419 9.92842 19.9325C9.92166 19.8562 9.91718 19.7715 9.91421 19.6745Z", fill: "currentColor" })
      ]
    }
  );
}
export {
  LightbulbBulk as default
};
