...
function RemoteControllerMinimalisticOutline({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
export {
  RemoteControllerMinimalisticOutline as default
};
