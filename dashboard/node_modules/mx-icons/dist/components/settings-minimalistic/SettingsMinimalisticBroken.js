...
function SettingsMinimalisticBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
export {
  SettingsMinimalisticBroken as default
};
