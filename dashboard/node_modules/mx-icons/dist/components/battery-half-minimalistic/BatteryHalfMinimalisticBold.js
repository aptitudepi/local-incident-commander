...
function BatteryHalfMinimalisticBold({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
export {
  BatteryHalfMinimalisticBold as default
};
