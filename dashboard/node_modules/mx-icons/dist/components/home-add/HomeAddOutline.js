...
function HomeAddOutline({
  ...
  return /* @__PURE__ */ jsxs(
    Icon,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx("path", { d: "M12.75 10.9998C12.75 10.5856 12.4142 10.2498 12 10.2498C11.5858 10.2498 11.25 10.5856 11.25 10.9998L11.25 13.2498H9C8.58579 13.2498 8.25 13.5856 8.25 13.9998C8.25 14.414 8.58579 14.7498 9 14.7498H11.25V16.9998C11.25 17.414 11.5858 17.7498 12 17.7498C12.4142 17.7498 12.75 17.414 12.75 16.9998L12.75 14.7498H15C15.4142 14.7498 15.75 14.414 15.75 13.9998C15.75 13.5856 15.4142 13.2498 15 13.2498H12.75V10.9998Z", fill: "currentColor" }),
