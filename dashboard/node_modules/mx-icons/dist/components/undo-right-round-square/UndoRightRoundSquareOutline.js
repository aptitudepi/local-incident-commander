...
function UndoRightRoundSquareOutline({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
export {
  UndoRightRoundSquareOutline as default
};
