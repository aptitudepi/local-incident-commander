...
function EmptyWalletTimeOutline({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return /* @__PURE__ */ jsxs(
    Icon,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("path", { d: "M5 23.75C2.38 23.75 0.25 21.62 0.25 19C0.25 17.54 0.899999 16.19 2.03 15.29C2.87 14.62 3.93 14.25 5 14.25C7.62 14.25 9.75 16.38 9.75 19C9.75 20.36 9.16 21.66 8.14 22.56C7.26 23.33 6.15 23.75 5 23.75ZM5 15.75C4.26 15.75 3.56 16 2.97 16.47C2.2 17.08 1.75 18.01 1.75 19C1.75 20.79 3.21 22.25 5 22.25C5.78 22.25 6.53999 21.96 7.14999 21.44C7.84999 20.82 8.25 19.94 8.25 19C8.25 17.21 6.79 15.75 5 15.75Z", fill: "currentColor" }),
        /* @__PURE__ */ jsx("path", { d: "M3.99988 20.75C3.74988 20.75 3.49988 20.62 3.35988 20.39C3.14988 20.03 3.25988 19.57 3.61988 19.36L4.50988 18.83V17.75C4.50988 17.34 4.84988 17 5.25988 17C5.66988 17 6.00988 17.34 6.00988 17.75V19.25C6.00988 19.51 5.86988 19.76 5.64988 19.89L4.39988 20.64C4.26988 20.72 4.12988 20.75 3.99988 20.75Z", fill: "currentColor" })
      ]
    }
  );
}
export {
  EmptyWalletTimeOutline as default
};
