...
function FolderFavouriteBookmarkLinear({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
export {
  FolderFavouriteBookmarkLinear as default
};
