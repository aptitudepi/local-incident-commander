...
function FolderFavouriteBookmarkTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
export {
  FolderFavouriteBookmarkTwotone as default
};
