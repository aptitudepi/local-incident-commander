...
function HeartSearchBold({
  ...
  return /* @__PURE__ */ jsxs(
    Icon,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx("path", { d: "M21.74 20.5083L20.88 19.6483C21.33 18.9683 21.59 18.1583 21.59 17.2883C21.59 14.9183 19.67 12.9883 17.29 12.9883C14.91 12.9883 13 14.9183 13 17.2983C13 19.6783 14.92 21.5983 17.3 21.5983C18.17 21.5983 18.98 21.3383 19.66 20.8883L20.52 21.7483C20.69 21.9183 20.91 22.0083 21.14 22.0083C21.37 22.0083 21.59 21.9183 21.76 21.7483C22.09 21.3983 22.09 20.8483 21.74 20.5083Z", fill: "currentColor" }),
