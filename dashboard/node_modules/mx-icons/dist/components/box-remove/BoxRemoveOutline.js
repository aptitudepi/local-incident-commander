  ...
  return /* @__PURE__ */ jsxs(
    Icon,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("path", { d: "M19 22.75C17.34 22.75 15.78 21.87 14.94 20.44C14.49 19.72 14.25 18.87 14.25 18C14.25 16.54 14.9 15.19 16.03 14.29C16.87 13.62 17.93 13.25 19 13.25C21.62 13.25 23.75 15.38 23.75 18C23.75 18.87 23.51 19.72 23.06 20.45C22.82 20.87 22.49 21.25 22.11 21.57C21.28 22.33 20.17 22.75 19 22.75ZM19 14.75C18.26 14.75 17.56 15 16.97 15.47C16.2 16.08 15.75 17.01 15.75 18C15.75 18.59 15.91 19.17 16.22 19.67C16.81 20.67 17.85 21.25 19 21.25C19.79 21.25 20.55 20.96 21.13 20.44C21.39 20.22 21.61 19.96 21.77 19.68C22.09 19.17 22.25 18.59 22.25 18C22.25 16.21 20.79 14.75 19 14.75Z", fill: "currentColor" }),
        /* @__PURE__ */ jsx("path", { d: "M20.0704 19.7901C19.8804 19.7901 19.6904 19.7201 19.5404 19.5701L17.4304 17.4601C17.1404 17.1701 17.1404 16.6901 17.4304 16.4001C17.7204 16.1101 18.2004 16.1101 18.4904 16.4001L20.6004 18.5101C20.8904 18.8001 20.8904 19.2801 20.6004 19.5701C20.4504 19.7201 20.2604 19.7901 20.0704 19.7901Z", fill: "currentColor" }),
        /* @__PURE__ */ jsx("path", { d: "M17.9311 19.8199C17.7411 19.8199 17.5511 19.7499 17.4011 19.5999C17.1111 19.3099 17.1111 18.8299 17.4011 18.5399L19.5111 16.4299C19.8011 16.1399 20.2811 16.1399 20.5711 16.4299C20.8611 16.7199 20.8611 17.1999 20.5711 17.4899L18.4611 19.5999C18.3111 19.7499 18.1211 19.8199 17.9311 19.8199Z", fill: "currentColor" })
      ]
    }
  );
}
export {
  BoxRemoveOutline as default
};
