  ...
  return /* @__PURE__ */ jsxs(
    Icon,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("path", { d: "M9.70096 15.75C9.5 16.0981 9.5 16.5654 9.5 17.5C9.5 18.4346 9.5 18.9019 9.70096 19.25C9.83261 19.478 10.022 19.6674 10.25 19.799C10.5981 20 11.0654 20 12 20C12.9346 20 13.4019 20 13.75 19.799C13.978 19.6674 14.1674 19.478 14.299 19.25C14.5 18.9019 14.5 18.4346 14.5 17.5C14.5 16.5654 14.5 16.0981 14.299 15.75C14.1674 15.522 13.978 15.3326 13.75 15.201C13.4019 15 12.9346 15 12 15C11.0654 15 10.5981 15 10.25 15.201C10.022 15.3326 9.83261 15.522 9.70096 15.75Z", fill: "currentColor" }),
        /* @__PURE__ */ jsx("path", { d: "M17 17.5C17 16.5654 17 16.0981 17.201 15.75C17.3326 15.522 17.522 15.3326 17.75 15.201C18.0981 15 18.5654 15 19.5 15C20.4346 15 20.9019 15 21.25 15.201C21.478 15.3326 21.6674 15.522 21.799 15.75C22 16.0981 22 16.5654 22 17.5C22 18.4346 22 18.9019 21.799 19.25C21.6674 19.478 21.478 19.6674 21.25 19.799C20.9019 20 20.4346 20 19.5 20C18.5654 20 18.0981 20 17.75 19.799C17.522 19.6674 17.3326 19.478 17.201 19.25C17 18.9019 17 18.4346 17 17.5Z", fill: "currentColor" })
      ]
    }
  );
}
export {
  Reorder2Bold as default
};
