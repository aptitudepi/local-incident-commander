...
function NotificationLinesRemoveBold({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return /* @__PURE__ */ jsxs(
    Icon,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2L12.2578 2.00001C11.8534 2.5665 11.6799 3.2054 11.5958 3.83127C11.4998 4.54482 11.4999 5.4264 11.5 6.40759V6.59241C11.4999 7.5736 11.4998 8.45518 11.5958 9.16873C11.7005 9.94777 11.9437 10.747 12.5983 11.4017C13.253 12.0563 14.0522 12.2995 14.8313 12.4042C15.5448 12.5002 16.4264 12.5001 17.4076 12.5H17.5924C18.5736 12.5001 19.4552 12.5002 20.1687 12.4042C20.7946 12.3201 21.4335 12.1466 22 11.7422L22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22ZM6.25 14C6.25 13.5858 6.58579 13.25 7 13.25H11C11.4142 13.25 11.75 13.5858 11.75 14C11.75 14.4142 11.4142 14.75 11 14.75H7C6.58579 14.75 6.25 14.4142 6.25 14ZM6.25 17.5C6.25 17.0858 6.58579 16.75 7 16.75H13C13.4142 16.75 13.75 17.0858 13.75 17.5C13.75 17.9142 13.4142 18.25 13 18.25H7C6.58579 18.25 6.25 17.9142 6.25 17.5Z", fill: "currentColor" }),
...
export {
  NotificationLinesRemoveBold as default
};
