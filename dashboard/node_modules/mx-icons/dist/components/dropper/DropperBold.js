...
function DropperBold({
  ...
  return /* @__PURE__ */ jsxs(
    Icon,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx("path", { d: "M22 10.75V12.25H19C18.5858 12.25 18.25 12.5858 18.25 13C18.25 13.4142 18.5858 13.75 19 13.75H22V16.5069C22 17.1639 21.723 17.7906 21.2371 18.2329C19.9508 19.4037 18.3701 20.0673 16.75 20.2234V21.25C16.75 21.6642 16.4142 22 16 22C15.5858 22 15.25 21.6642 15.25 21.25V20.2234C13.6299 20.0673 12.0492 19.4037 10.7629 18.2329C10.277 17.7906 10 17.1639 10 16.5069V10C10 8.11438 10 7.17157 10.5858 6.58579C11.1716 6 12.1144 6 14 6H18C19.8856 6 20.8284 6 21.4142 6.58579C21.9166 7.08814 21.9881 7.85306 21.9983 9.25H18C17.5858 9.25 17.25 9.58579 17.25 10C17.25 10.4142 17.5858 10.75 18 10.75H22Z", fill: "currentColor" }),
