...
function VideoMusicLibrary2Outline({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
export {
  VideoMusicLibrary2Outline as default
};
