...
function CallOutgoingBold({
  ...
  return /* @__PURE__ */ jsxs(
    Icon,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx("path", { d: "M19.9992 9.55C19.5892 9.55 19.2492 9.21 19.2492 8.8V4.75H15.1992C14.7892 4.75 14.4492 4.41 14.4492 4C14.4492 3.59 14.7892 3.25 15.1992 3.25H19.9992C20.4092 3.25 20.7492 3.59 20.7492 4V8.8C20.7492 9.21 20.4092 9.55 19.9992 9.55Z", fill: "currentColor" }),
