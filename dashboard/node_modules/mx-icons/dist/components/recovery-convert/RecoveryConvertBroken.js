...
function RecoveryConvertBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return /* @__PURE__ */ jsxs(
    Icon,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx("path", { d: "M5.5293 15.9799C5.6993 17.7699 6.6393 18.4999 8.6893 18.4999H11.4193C13.6993 18.4999 14.6093 17.5899 14.6093 15.3099V12.5799C14.6093 10.3099 13.6993 9.3999 11.4193 9.3999H8.6893C6.6193 9.3999 5.6793 10.1499 5.5293 11.9999", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }),
        /* @__PURE__ */ jsx("path", { d: "M18.5004 8.68V11.41C18.5004 13.69 17.5904 14.6 15.3104 14.6H14.6004V12.58C14.6004 10.31 13.6904 9.4 11.4104 9.4H9.40039V8.68C9.40039 6.4 10.3104 5.5 12.5904 5.5H15.3204C17.5904 5.5 18.5004 6.41 18.5004 8.68Z", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }),
...
export {
  RecoveryConvertBroken as default
};
