...
function EmptyWalletAddOutline({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return /* @__PURE__ */ jsxs(
    Icon,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("path", { d: "M6.49 19.73H3.5C3.09 19.73 2.75 19.39 2.75 18.98C2.75 18.57 3.09 18.23 3.5 18.23H6.49C6.9 18.23 7.24 18.57 7.24 18.98C7.24 19.39 6.91 19.73 6.49 19.73Z", fill: "currentColor" }),
...
export {
  EmptyWalletAddOutline as default
};
