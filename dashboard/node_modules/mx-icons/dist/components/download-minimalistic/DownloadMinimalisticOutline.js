...
function DownloadMinimalisticOutline({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
export {
  DownloadMinimalisticOutline as default
};
