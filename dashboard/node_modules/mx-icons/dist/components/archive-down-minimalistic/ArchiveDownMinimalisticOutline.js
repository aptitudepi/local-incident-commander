...
function ArchiveDownMinimalisticOutline({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
export {
  ArchiveDownMinimalisticOutline as default
};
