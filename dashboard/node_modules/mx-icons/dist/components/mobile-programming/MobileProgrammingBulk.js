...
function MobileProgrammingBulk({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return /* @__PURE__ */ jsxs(
    Icon,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("path", { opacity: "0.4", d: "M21 7V14C20.17 13.37 19.13 13 18 13C15.24 13 13 15.24 13 18C13 19.63 13.79 21.09 15 22H8C4.5 22 3 20 3 17V7C3 4 4.5 2 8 2H8.92999L8.97 3.53003C8.99 4.34003 9.66 5 10.47 5H13.5C14.32 5 15 4.32 15 3.5V2H16C19.5 2 21 4 21 7Z", fill: "currentColor" }),
        /* @__PURE__ */ jsx("path", { d: "M14.9997 2V3.5C14.9997 4.32 14.3197 5 13.4997 5H10.4697C9.6597 5 8.9897 4.34003 8.9697 3.53003L8.92969 2H14.9997Z", fill: "currentColor" })
      ]
    }
  );
}
export {
  MobileProgrammingBulk as default
};
